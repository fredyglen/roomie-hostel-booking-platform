  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 py-12 bg-white">
        <h1 className="text-[#007BFF] text-4xl md:text-5xl font-['Manrope'] font-bold leading-tight tracking-tight text-center pb-4">
          Get in Touch
        </h1>
        <p className="text-[#6B7280] text-base md:text-lg font-['Work_Sans'] font-light leading-relaxed text-center max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="px-6 py-12 space-y-6 bg-white max-w-3xl mx-auto w-full">
        ...
        <label className="flex flex-col min-w-40 flex-1">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#1C1C1E] focus:outline-0 focus:ring-2 focus:ring-[#007BFF]/50 border border-gray-300 bg-white focus:border-[#007BFF] h-14 p-4 text-base font-['Work_Sans'] font-light leading-normal transition-all duration-200"
            >
        ...
        <label className="flex flex-col min-w-40 flex-1">
          ...
          <textarea
            ...
            className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#1C1C1E] focus:outline-0 focus:ring-2 focus:ring-[#007BFF]/50 border border-gray-300 bg-white focus:border-[#007BFF] placeholder:text-gray-400 p-4 text-base font-['Work_Sans'] font-light leading-relaxed transition-all duration-200"
        ...
        <button
          type="submit"
          className="mt-6 flex h-11 w-full items-center justify-center rounded-md bg-[#007BFF] px-5 text-sm font-['Manrope'] font-semibold text-white hover:bg-[#0056D6] focus:outline-none focus:ring-2 focus:ring-[#007BFF]/50 transition-colors"
        >
          Send Message
        </button>
      </form>
      ...
      <div className="px-6 py-12 border-t border-gray-200 bg-white">
        <div className="space-y-4 max-w-3xl mx-auto">
          <a
            className="flex items-center p-6 rounded-xl bg-white border border-gray-200 hover:border-[#007BFF] transition-colors duration-200"
            href="tel:+233501234567"
          >
            <div className="flex items-center justify-center size-12 bg-[#007BFF] rounded-xl mr-5">
          ...
          <a
            className="flex items-center p-6 rounded-xl bg-[#0B1120] border border-[#007BFF] hover:border-[#007BFF] transition-colors duration-200"
            href="/ambassador"
          >
            <div className="flex items-center justify-center size-12 bg-[#FBBF24] rounded-xl mr-5">
              <MaterialIcon name="campaign" className="text-[#1F2937] text-2xl" />
            </div>
            <span className="flex-1 text-white font-['Manrope'] font-semibold text-lg">Become a campus ambassador</span>
            <MaterialIcon name="chevron_right" className="text-[#9CA3AF] text-2xl" />
          </a>
        </div>
        <div className="text-center mt-8 text-base text-[#6B7280] font-['Work_Sans'] font-light">
          <p>Office hours: Mon - Fri, 9:00am - 5:00pm</p>
        </div>
      </div>
      ...
      <div className="px-6 py-12 text-center bg-white">
        ...
        <div className="flex justify-center space-x-8">
          <a className="text-[#6B7280] hover:text-[#007BFF] transition-colors duration-200" href="#">
      ...
      {/* FAQ Section */}
      <div className="px-6 py-20 border-t border-gray-200 bg-white">
        <h3 className="text-3xl md:text-4xl font-['Manrope'] font-bold text-[#007BFF] mb-8 text-center">Frequently asked questions</h3>
        <div className="space-y-4 max-w-3xl mx-auto">
          <details className="group rounded-xl bg-white border border-gray-200 p-6 transition-colors duration-200">

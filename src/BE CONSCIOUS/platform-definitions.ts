 ...
 * Note: Compound management is implemented as a premium feature for grouping multiple properties
 */
export type PropertyType = 'hostel' | 'apartment' | 'homestel';

/**
 * Property categories for classification
 * Note: Compound is removed - will be implemented as property grouping feature
 */
export type PropertyCategory = 'Hostel' | 'Apartment' | 'Homestel' | 'Single Room';

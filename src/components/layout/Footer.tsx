...
const Footer: React.FC = () => {
  return (
    <footer className="bg-roomi-dark text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Logo variant="white" />
            <p className="mt-4 text-gray-300">
              ROOMi helps students find safe, affordable housing near campus with verified listings,
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span>University Street, Accra, Ghana</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">📞</span>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-center text-gray-400">
            &copy; {new Date().getFullYear()} ROOMi. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
